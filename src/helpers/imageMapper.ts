...
const specialistImageMap: { [key: string]: any } = {
  specialist_one: require('../assets/images/specialist_one.png'),
  specialist_two: require('../assets/images/specialist_two.png'),
  specialist_three: require('../assets/images/specialist_three.png'),
  specialist_four: require('../assets/images/specialist_four.png'),
  specialist_five: require('../assets/images/specialist_five.png'),
  specialist_six: require('../assets/images/specialist_six.png'),
};
...
export const getSpecialistImage = (imageKey: string): any => {
  return specialistImageMap[imageKey] ?? specialistImageMap['specialist_one'];
};
